...
int main(){
    ...
    //cerr<<"slash zero obj:" << a.currentCount() << endl;
	...
	cerr<<"## After combine c_result contains:"<<endl;
	c_result.trace();
	...
	cerr<<"## After subtract c_result contains:"<<endl;
	c_result.trace();
    ...
    cout<<"final number of node in every bag:"<<endl;
	cerr<<a.size()<<endl;
	cerr<<a_copy.size()<<endl;
	cerr<<a_assignment.size()<<endl;
	cerr<<b.size()<<endl;
	cerr<<c1.size()<<endl;
	cerr<<c2.size()<<endl;
    cerr<<c_result.size()<<endl<<endl;
